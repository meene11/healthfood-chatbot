...
*▲ 실험 1~7: Hit@1 / Hit@3 / Hit@5 변화 추이*

![핵심 실험 단계별 성과](results/chart4_key_experiments.png)
*▲ 임베딩 교체(Exp5)가 단일 최대 개선 포인트임을 확인*
...
*▲ 실험 8: 3개 모델 품질 점수(0~3점) 분포 비교 — Llama가 0점 비율이 가장 낮음*
...
*▲ 실험 9: 품질 점수 vs 응답 속도 산점도 — Gemini가 품질·속도 균형 최우수*

![실험8 vs 실험9 모델 품질 변화](results/model_comparison/exp9_chart5_exp8vs9.png)
*▲ 조원 QA(Exp8) → 내부 QA(Exp9): Llama 급락, Gemini 가장 안정적*
...
*▲ 실험 9 → 10: HyDE 도입 전후 모델별 품질 비교*

![HyDE 모델별 개선폭](results/model_comparison/exp10_chart2_improvement.png)
*▲ HyDE 적용 시 GPT +0.214, Gemini +0.119 — Llama는 Hit@5에서 효과*
...
*▲ 실험 9 → 11: 쿼리 확장 도입 후 모델별 품질 트렌드*

![쿼리 확장 모델별 개선폭](results/model_comparison/exp11_chart2_improvement.png)
*▲ GPT +0.357 최대 향상, Llama는 컨텍스트 과부하로 오히려 하락*
...
*▲ 3개 모델 다차원 종합 비교: 품질·속도·안정성·비용 — Gemini가 가장 균형 잡힌 형태*

![비용 대비 성능 비교](results/model_comparison/chart_cmp5_cost_perf.png)
*▲ 비용 대비 성능: 무료인 Gemini가 GPT(유료)와 대등하거나 우수*
